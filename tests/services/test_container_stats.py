from llama_launcher.services.container_stats import (
    parse_container_stats, parse_size, ContainerStat,
)

_PODMAN = ('[{"id":"070c477a2980","name":"llama-qwen","cpu_percent":"18.5%",'
...
def test_parse_container_stats_podman():
    ...
    assert s == ContainerStat(name="llama-qwen", cpu_pct=18.5,
