...
def test_stopped_instance_card_offers_stop(win):
    # Cards carry a single stop action regardless of running state (the old
    # table's distinct Remove-for-stopped affordance is gone with the table).
    stopped = []
